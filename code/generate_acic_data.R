...
# Rename columns
colnames(raw_data) <- c("schoolid", "Tr","Y","S3","C1","C2","C3","XC","X1","X2","X3","X4","X5")
# Generate tau
tau_true <- function(X) {
...
data_2018$Ytrue <- ifelse(data_2018$Z, data_2018$Y+data_tau, data_2018$Y)
...
write.csv(data_2018, "~/Desktop/bart-sims/data/ACIC2018.csv")
...
write.csv(data_2017, "~/Desktop/bart-sims/data/ACIC2017.csv")
...
write.csv(data_2016,"~/Desktop/bart-sims/data/ACIC2016.csv")
